      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-text-dim">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded border border-border-dim">
            <span className="font-orbitron text-[9px] tracking-[0.2em] text-white uppercase">Smart Contract</span>
            <a
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5 px-2.5 py-1 rounded border border-neon-dim/30 bg-neon-dim/5">
              ...
              <span className="font-orbitron text-[9px] tracking-[0.2em] text-white uppercase">
                X1 Testnet
              </span>
            </div>

            {/* Anchor badge */}
            <div className="px-2.5 py-1 rounded border border-border-dim text-[9px] font-orbitron tracking-wider text-white uppercase">
              Anchor 0.30
            </div>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 px-2.5 py-1 rounded border border-border-dim text-white hover:text-purple-light hover:border-purple-light/40 transition-colors"
          >
